...
export class UIManager {
  ...
  initializeElements() {
    this.elements = {
      ...
      jpegQualityInput: DOMSelector.target('jpeg-quality-input'),
      ...
      pngCompressionInput: DOMSelector.target('png-compression-input'),
      ...
      webpQualityInput: DOMSelector.target('webp-quality-input'),
